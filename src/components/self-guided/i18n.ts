...
const T = {
  en: {
    ...
    accessNotOpenTitle: "Not open yet",
    accessNotOpenBody: "You chose to walk on a later date. The tour opens on the evening before, on {date}. Come back then — the link stays the same.",
  ...
  fr: {
    ...
    accessNotOpenTitle: "Pas encore ouvert",
    accessNotOpenBody: "Vous avez choisi une date plus tard. La visite s’ouvre la veille au soir, le {date}. Revenez à ce moment-là — le lien reste le même.",
