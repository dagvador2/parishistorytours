export const en = {
  ...
  home: {
    ...
    welcome: {
      title: "Welcome",
      intro: "I'm <strong>Clément</strong>, a passionate history enthusiast and independent tour guide.<br/>I offer immersive walking tours focused on World War&nbsp;II in Paris — and soon on other topics.",
      description: "Whether you're a curious traveler, a history lover, or an educator, my tours are designed to bring the past to life through stories, places, and personal insights."
    },
    gallery: {
      title: "Gallery",
