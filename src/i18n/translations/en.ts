...
export const en = {
  ...
  faq: {
    selfGuided: [
      { question: "How does the self-guided tour work?", answer: "After payment you receive an email with a personal link. Open it on your phone: a map shows the route and your position, and the narration starts when you reach each stop. Subtitles and the archive photographs follow the audio." },
      { question: "Do I need an internet connection during the walk?", answer: "No. Open the page once on wifi (at your hotel, for instance) and wait for “Ready for offline use”: the audio, the photographs and the map of the Latin Quarter are then stored on your phone. GPS works without data." },
      { question: "How long do I have access?", answer: "You pick the day you plan to walk. The tour opens the evening before and stays open for a few days after it, so you can buy weeks ahead without losing anything. Once the page has been loaded on wifi it keeps working offline until the end of that window. If your trip moves, write to me and I will shift the dates." },
      { question: "Can I offer it as a gift?", answer: "Yes. Enter the recipient’s email at checkout and, if you know it, the day they will walk: the access link and the explanatory sheet go to them, and the tour opens on the right day." },
      { question: "What if my phone has no GPS, or I refuse location access?", answer: "The tour still works: tap a stop on the map to start its narration, and the app tells you where the next one is." },
      { question: "Is it available in English?", answer: "The interface and the price include both languages. The French narration is available today; the English narration is being recorded and will appear in your tour automatically, at no extra cost." }
    ],
  ...
  meta: {
    selfGuided: {
      ...
      description: "Walk the Left Bank WWII tour on your own time: 9 audio sections narrated by the guide, GPS map, synchronised archive photographs, works offline. One purchase, English and French."
    },
    selfGuidedSuccess: {
  ...
  quiet: {
    ...
    home: {
      hero: {
        posterTag: "Paris · 1940 — 1944",
        headlineLead: "From Occupation to",
        headlineAccent: "Liberation",
        headlineTail: ", street by street",
        lede: "Private walking tours led by an independent guide who goes back to the sources: some twenty books, memoirs, period newspapers. The Fall, the Resistance, the Liberation — and two thousand years of Paris history for those who want to go further.",
        bookCta: "Book a Tour",
        browseCta: "Browse Tours",
        seeRouteCta: "See the Route",
        mediaGuideAlt: "Clément Daguet-Schott holding an archive photograph in front of Notre-Dame de Paris",
        mediaGuideLabel: "Clément, your guide",
        mediaGuideCaption: "Period photographs in hand",
        mediaPlaceAlt: "The Luxembourg Palace seen from the garden",
        mediaPlaceLabel: "Luxembourg Palace",
        mediaPlaceCaption: "Luftwaffe headquarters",
        mediaGroupAlt: "Clément and his group walking down a Paris boulevard",
        mediaGroupLabel: "Private groups",
        mediaGroupCaption: "Ten people maximum",
        statToursValue: "4",
      ...
      tours: {
        ...
        leftBankBadge: "WW2",
        leftBankImgAlt: "Notre-Dame de Paris",
        rightBankImgAlt: "Place Vendôme",
        leftBankNumeral: "I",
  ...
  selfGuided: {
    ...
    success: {
      ...
      body: "We are preparing your personal access link. Check your inbox (and the spam folder) in the next minute.",
      ready: "Your access is ready.",
      open: "Open the tour",
      slow: "This is taking longer than usual. The email will arrive shortly; if not, write to clement@parishistorytours.com.",
