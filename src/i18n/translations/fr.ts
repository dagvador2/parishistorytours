...
export const fr = {
  ...
  faq: {
    selfGuided: [
      ...
      { question: "Combien de temps ai-je accès ?", answer: "Vous choisissez le jour où vous comptez marcher. La visite s’ouvre la veille au soir et reste ouverte quelques jours après, vous pouvez donc acheter des semaines à l’avance sans rien perdre. Une fois la page chargée en wifi, elle continue de fonctionner hors ligne jusqu’à la fin de cette fenêtre. Si votre voyage bouge, écrivez-moi et je décale les dates." },
      { question: "Puis-je l’offrir ?", answer: "Oui. Indiquez l’email du destinataire au paiement et, si vous la connaissez, la date de sa balade : le lien d’accès et la fiche explicative lui sont envoyés, et la visite s’ouvre le bon jour." },
  ...
  quiet: {
    ...
    home: {
      hero: {
        ...
        headlineLead: "De l'Occupation à la",
        headlineAccent: "Libération",
        headlineTail: ", rue par rue",
        lede: "Visites privées à pied, menées par un guide indépendant qui remonte aux sources : une vingtaine d'ouvrages, des mémoires, des journaux d'époque. La Chute, la Résistance, la Libération — et deux mille ans d'histoire de Paris pour qui veut aller plus loin.",
        bookCta: "Réserver une visite",
        browseCta: "Voir les visites",
        seeRouteCta: "Voir le parcours",
        mediaGuideAlt: "Clément Daguet-Schott tenant une photo d'archive devant Notre-Dame de Paris",
        mediaGuideLabel: "Clément, votre guide",
        mediaGuideCaption: "Photos d'époque à l'appui",
        mediaPlaceAlt: "Le palais du Luxembourg vu depuis le jardin",
        mediaPlaceLabel: "Palais du Luxembourg",
        mediaPlaceCaption: "Quartier général de la Luftwaffe",
        mediaGroupAlt: "Clément et son groupe marchant sur un boulevard parisien",
        mediaGroupLabel: "Groupes privés",
        mediaGroupCaption: "Dix personnes au maximum",
        statToursValue: "4",
