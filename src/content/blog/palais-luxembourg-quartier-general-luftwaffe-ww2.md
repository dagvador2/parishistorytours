---
title: "Le Palais du Luxembourg : du Sénat français au QG de la Luftwaffe"
description: "Comment le Palais du Luxembourg est devenu le quartier général de la Luftwaffe pendant la Seconde Guerre mondiale. Histoire de l'Occupation et visite guidée Rive Gauche."
...
## Un palais de reine devenu poste de commandement
...
**Vous pouvez visiter cet endroit exact lors de notre [visite guidée WWII de la Rive Gauche](/fr/tours/left-bank).** Je vous emmènerai à travers les jardins, devant le palais, et le long des rues où la Libération s'est jouée. Vous verrez les impacts de balles, vous entendrez les récits, et vous comprendrez pourquoi ce lieu — si paisible aujourd'hui — porte un tel poids d'histoire.

---

*Envie de traverser le Jardin du Luxembourg avec un guide qui connaît chaque strate de son histoire ? [Réservez une visite privée Rive Gauche](/fr/tours/left-bank) et découvrez les histoires cachées de la Seconde Guerre mondiale au cœur du Quartier latin.*
