...
export const tours: Record<string, TourConfig> = {
  'left-bank': {
    ...
    ogImage: '/photos/left_bank/Paris_WW2_left_bank_og.webp',
    ...
    galleryDesktop: [
      ...
      { src: '/photos/left_bank/Paris_WW2_group_notre_dame_parvis.webp', alt: 'The group on the Notre-Dame square, final stop of the tour' },
      { src: '/photos/left_bank/Paris_WW2_guide_notre_dame_smile.webp', alt: 'Clément, your guide, in front of Notre-Dame' },
      { src: '/photos/left_bank/Paris_WW2_group_sorbonne.webp', alt: 'Telling the story of the Resistance outside the Sorbonne' },
      { src: '/photos/left_bank/Paris_WW2_group_saint_germain.webp', alt: 'The group listening in the streets of Saint-Germain-des-Prés' },
      { src: '/photos/left_bank/Paris_WW2_group_street_listening.webp', alt: 'A small private group on the Left Bank' },
      { src: '/photos/left_bank/Paris_WW2_group_boulevard_walk.webp', alt: 'Walking between two WWII sites on the Left Bank' },
      { src: '/photos/left_bank/saint_severin_church_paris.webp', alt: 'Church of Saint-Séverin in the Latin Quarter' },
    ],
    galleryMobile: [
      { src: '/photos/left_bank/Paris_WW2_group_photo_luxembourg.webp', alt: 'Tour group in the Luxembourg Garden at the end of the walk' },
      { src: '/photos/left_bank/Paris_WW2_group_notre_dame_parvis.webp', alt: 'The group on the Notre-Dame square, final stop of the tour' },
